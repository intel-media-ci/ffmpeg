...
#define DXVA_CONTEXT_DECODER(avctx, ctx)        DXVA2_CONTEXT_VAR(avctx, ctx, decoder)
#define DXVA_CONTEXT_CFG(avctx, ctx)            DXVA2_CONTEXT_VAR(avctx, ctx, cfg)
...
unsigned *ff_dxva2_get_report_id(AVCodecContext *avctx, AVDXVAContext *ctx);
