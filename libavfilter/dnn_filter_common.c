...
{
    DNNBackendType backend = ctx->backend_type;
    return backend == DNN_TH ? ctx->model->get_output(ctx->model->model, ctx->model_inputname, input_width, input_height,
                                                      NULL, output_width, output_height) :
                               ctx->model->get_output(ctx->model->model, ctx->model_inputname, input_width, input_height,
